...
MainTab:AddDropdown("ApplyMethod", {
...
-- Emote modifications di MainTab
...
MainTab:AddInput("EmoteSpeedValue", {
...
MainTab:AddToggle("InfiniteSlide", {
    Title = "Infinite Slide",
...
MainTab:AddInput("SlideFriction", {
...
MainTab:AddInput("BackJumpSpeed", {
...
MainTab:AddInput("FrontJumpSpeed", {
...
MainTab:AddInput("LagSwitchDuration", {
...
MainTab:AddDropdown("RespawnMethod", {
...
MainTab:AddToggle("AutoSelfRevive", {
...
MainTab:AddToggle("AutoCarryGUI", {
...
MainTab:AddToggle("AutoReviveGUI", {
...
MiscTab:AddInput("CurrentCosmetics", {
...
MiscTab:AddInput("SelectCosmetics", {
...
VisualTab:AddToggle("ESPNextbot", {
    Title = "ESP Nextbot",
...
VisualTab:AddToggle("TracerDowned", {
...
MiscTab:AddToggle("CameraStretch", {
...
MiscTab:AddInput("StretchHorizontal", {
...
MiscTab:AddInput("StretchVertical", {
...
-- Fake Streaks di MiscTab
MiscTab:AddInput("FakeStreaks", {
    Title = "Fake Streaks",
